...
const ContactForm = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const newContact = {
            ...
            phone: phone,
            address: address,
            agenda_slug: "GeFernando"
        };

        const url = id 
            ? `https://playground.4geeks.com/contact/agendas/GeFernando/contacts/${id}` 
            : "https://playground.4geeks.com/contact/agendas/GeFernando/contacts/";
